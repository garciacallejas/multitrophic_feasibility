...
feasibility_metrics <- function(A,
  ...
  if (f(A) == FALSE) {
    ...
    res <- res.noise.df %>%
      summarise(small_omega_mean = mean(small_omega_mean),
                small_omega_lowerCI = mean(small_omega_lowerCI),
                small_omega_upperCI = mean(small_omega_upperCI),
                omega_isotropic = mean(omega_isotropic),
                isotropy_index_mean = mean(isotropy_index_mean),
                isotropy_index_lowerCI = mean(isotropy_index_lowerCI),
                isotropy_index_upperCI = mean(isotropy_index_upperCI))
